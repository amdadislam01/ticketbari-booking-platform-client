    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-lg text-gray-500">Manage your account & track your journey with TicketBari</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="text-center mt-6">
                  ...
                  <div className="mt-4 inline-flex items-center gap-2 px-5 py-2 rounded-full text-sm font-semibold border">
                    <FaIdBadge className={`${
                      ...
                      role === "fraud" ? "text-red-500" : "text-yellow-600"
                    }`} />
                    <span className={`capitalize ${
                      ...
                      {role === "fraud" ? "Restricted User" : role || "Passenger"}
                    </span>
                  </div>
                </div>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            {/* Stats Grid */}
            <div className={`grid grid-cols-2 md:grid-cols-4 gap-5 p-8 rounded-3xl shadow-xl border ${
              isDarkMode ? "bg-gray-900 border-gray-800" : "bg-white border-gray-200"
            }`}>
              {[
                { label: "Total Bookings", value: bookingData?.length || 0, color: "from-purple-500 to-pink-500" },
                { label: "Total Spent", value: `৳${userData?.totalSpent || 10}`, color: "from-green-500 to-emerald-500" },
                { label: "Active Tickets", value: userData?.length || 10, color: "from-blue-500 to-cyan-500" },
                { label: "Trips Completed", value: userData?.completedTrips || 10, color: "from-orange-500 to-red-500" },
              ].map((stat, i) => (
                <div key={i} className="text-center group">
                  <div className={`h-20 w-20 mx-auto mb-3 rounded-2xl bg-linear-to-br ${stat.color} p-1`}>
                    <div className="h-full w-full bg-white dark:bg-gray-900 rounded-2xl flex items-center justify-center text-2xl font-bold text-gray-800 dark:text-white">
                      {stat.value}
                    </div>
                  </div>
                  <p className="text-sm text-gray-500 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition">
                    {stat.label}
                  </p>
                </div>
              ))}
            ...
            {role === "fraud" && (
              <div className="p-6 bg-linear-to-r from-red-900 to-red-800 rounded-2xl border border-red-700 shadow-2xl text-white text-center">
                ...
                <p className="mt-2 opacity-90">
                  Your account has been flagged for suspicious activity. Ticket management features are disabled.
                </p>
              </div>
            )}
